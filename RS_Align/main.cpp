...
const cv::String  WINDOW_NAME_1("Camera video");
const cv::String  WINDOW_NAME_2("RGB video");
...
int main(int argc, char * argv[]) try
{
    ...
    while (app) // Application still alive?
    {
        ...
        cv::Mat openDepth((Size(width, height)), CV_16UC1, (void*)aligned_depth_frame.get_data(), Mat::AUTO_STEP);
 ...
 /////////////////// Process Depth Frame /////////////////////////////////////////////////////////////////////////
        ...
        int widthC = other_frame.get_width();
        int heightC = other_frame.get_height();
        Mat openColor((Size(640, 480)), CV_8UC3, (void*)other_frame.get_data(), Mat::AUTO_STEP);

        cv::cvtColor(openColor,openColor,COLOR_BGR2RGB);

        /// Display //////////////////////
         cv::imshow(WINDOW_NAME_1,oDepthOut);
        cv::imshow(WINDOW_NAME_2,openColor);
         cv::waitKey(50);


         ////////// Write To File ///////////////
         oVideoWriterC<<openColor;
